...
class ControllerTestimonialTestimonial extends Controller {
	...
	public function add() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$this->response->redirect($this->url->link($this->modulePath, 'user_token=' . $this->session->data['user_token'] . $url, 'SSL'));
		}
	...
	protected function getList() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link($this->modulePath, 'user_token=' . $this->session->data['user_token'] . $url, 'SSL')
		);

		$data['add'] = $this->url->link($this->modulePath . '/add', 'user_token=' . $this->session->data['user_token'] . $url, 'SSL');
		$data['delete'] = $this->url->link($this->modulePath . '/delete', 'user_token=' . $this->session->data['user_token'] . $url, 'SSL');
		...
		foreach ($results as $result) {
			$data['reviews'][] = array(
				...
				'edit'       => $this->url->link($this->modulePath . '/edit', 'user_token=' . $this->session->data['user_token'] . '&review_id=' . $result['review_id'] . $url, 'SSL')
			);
		}
		...
		$data['sort_author'] = $this->url->link($this->modulePath, 'user_token=' . $this->session->data['user_token'] . '&sort=author' . $url, 'SSL');
		$data['sort_rating'] = $this->url->link($this->modulePath, 'user_token=' . $this->session->data['user_token'] . '&sort=rating' . $url, 'SSL');
		$data['sort_status'] = $this->url->link($this->modulePath, 'user_token=' . $this->session->data['user_token'] . '&sort=status' . $url, 'SSL');
		$data['sort_date_added'] = $this->url->link($this->modulePath, 'user_token=' . $this->session->data['user_token'] . '&sort=date_added' . $url, 'SSL');
		...
		$pagination->url = $this->url->link($this->modulePath, 'user_token=' . $this->session->data['user_token'] . $url . '&page={page}', 'SSL');
	...
	protected function getForm() {
		...
		if (!isset($this->request->get['review_id'])) {
			$data['breadcrumbs'][] = array(
				...
				'href' => $this->url->link($this->modulePath . '/add', 'user_token=' . $this->session->data['user_token'] . $url, 'SSL')
			);
			$data['action'] = $this->url->link($this->modulePath . '/add', 'user_token=' . $this->session->data['user_token'] . $url, 'SSL');
		} else {
			$data['breadcrumbs'][] = array(
				'text' => $this->language->get('text_edit'),
				'href' => $this->url->link($this->modulePath . '/edit', 'user_token=' . $this->session->data['user_token'] . '&review_id=' . $this->request->get['review_id'] . $url, 'SSL')
			);
			$data['action'] = $this->url->link($this->modulePath . '/edit', 'user_token=' . $this->session->data['user_token'] . '&review_id=' . $this->request->get['review_id'] . $url, 'SSL');
		}

		$data['cancel'] = $this->url->link($this->modulePath, 'user_token=' . $this->session->data['user_token'] . $url, 'SSL');
