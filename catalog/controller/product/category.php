...
class ControllerProductCategory extends Controller {
	public function index() {
		...
		if (isset($this->request->get['rating']) && (int)$this->request->get['rating']) {
			$sort = 'rating';
			$order = (int)$this->request->get['rating'] == 1? 'DESC': 'ASC';
		}
		...
		if ($category_info) {
			$data['category_top'] = $category_info['parent_id']? false: true;
			...
			$results = $this->model_catalog_product->getProductsX($filter_data);
			...
			$data['filter_sp'] = $this->load->controller('product/filter_sp');
